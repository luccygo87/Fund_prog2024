...
# Primera dimensión: Ciudades (Quito,Cuenca,Esmeraldas)
# Segunda dimensión: Semanas (4 semanas)
# Tercera dimensión: Días de la semana (Lunes, Martes, Miércoles,Jueves,Viernes,Sabado,Domingo)
temperaturas = [
    [   # Ciudad 1: Quito
        [   # Semana 1
            {"day": "Lunes", "temp": 78},
...
for i, ciudad in enumerate(temperaturas):
    ...
    for j, semana in enumerate(ciudad):
        ...
        print(f"  Promedio Semana {j + 1}: {promedio:.2f} °F")